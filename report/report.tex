...
\begin{figure}[ht]
\begin{center}
 \includegraphics[width=6in]{transmissao}
\end{center}
...
O esquema geral dos componentes do circuito está na figura \ref{fig:montagem}.
...
Crystal Display}; controle, MCU (\textit{Micro Controler Unit}); e entradas os
