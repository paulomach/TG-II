...
controle discreto, etc). Este trabalho tenta, modestamente, resvalar cada
...
4.824kgf$) para enrolar o cabo que movimenta o \textit{derailleur}, o que é
discutido a seguir.
...
através dos botões está, para apenas um botão, na linha 16 a 21. Limitou-se a
